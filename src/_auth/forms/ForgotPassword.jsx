  ...
  return (
    ...
    {/*white side */}
      <div className='justify-center items-center mx-auto mt-32'>
        ...
        <div>
          <h1 className='text-blue-600 font-bold text-3xl py-2'>Forgot Password?</h1>
          <p className='font-normal text-base text-black'>Don’t worry, happens to all of us. Enter your email below to  <br />recover your password</p>
        </div>
        <div>
         {/* form */}
         <Formik
      ...
      {({ errors, touched }) => (
        <Form className='mt-8' >
          <fieldset>
            ...
            <Field id='email' className='text-sm font-normal text-black border-2 rounded-md py-2 px-4 border-[#0540F2]' name="email" type={toggle ?'text':'email'}
